...
var $author$project$Pages$PageB$lazy = false;
...
var $author$project$Pages$PageB$subView = function (model) {
	var _v0 = A2($elm$core$Debug$log, 'view PageB', _Utils_Tuple0);
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
	...
	return {
		body: _List_fromArray(
			[
				...
				$author$project$Pages$PageB$lazy ? A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Pages$PageB$subView, model) : $author$project$Pages$PageB$subView(model)
			]),
		title: 'PageB'
	};
};
...
var $author$project$Shared$view = F2(
	function (_v0, model) {
		var page = _v0.page;
		var toMsg = _v0.toMsg;
		var _v1 = A2($elm$core$Debug$log, 'view', _Utils_Tuple0);
		return {
			body: _List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							A3($mdgriffith$elm_ui$Element$rgb255, 116, 222, 165))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									$mdgriffith$elm_ui$Element$Background$color(
									A3($mdgriffith$elm_ui$Element$rgb255, 38, 104, 69))
								]),
							A2(
								...
								_List_fromArray(
									[
										...
										A2(
											...
											{description: 'Logo', src: '/icons/512.png'})),
										A2(
										$mdgriffith$elm_ui$Element$column,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$text('elm-spa-example')),
												A2(
										...
										_List_fromArray(
											[
												...
												$author$project$Shared$buttonAttrs,
												{
													label: $mdgriffith$elm_ui$Element$text('Page A'),
												...
												$author$project$Shared$buttonAttrs,
												{
													label: $mdgriffith$elm_ui$Element$text('Page B'),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.NotFound.Msg":{"args":[],"type":"Basics.Never"},"Pages.PageA.Msg":{"args":[],"type":"Basics.Never"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Shared":["Shared.Msg"],"Pages":["Spa.Generated.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Shared.Msg":{"args":[],"tags":{"ReplaceMe":[]}},"Spa.Generated.Pages.Msg":{"args":[],"tags":{"Top__Msg":["Pages.Top.Msg"],"NotFound__Msg":["Pages.NotFound.Msg"],"PageA__Msg":["Pages.PageA.Msg"],"PageB__Msg":["Pages.PageB.Msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.PageB.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[]}},"Pages.Top.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}}}}})}});
